...
/**
 * PaymentReturn generated by hbm2java
 */
public class PaymentReturn implements java.io.Serializable {

	private Integer paymentReturnId;
	...
	public PaymentReturn(BigDecimal purchaseAmount, BigDecimal authorizeAmount) {
		this.purchaseAmount = purchaseAmount;
		this.authorizeAmount = authorizeAmount;
	}

	public PaymentReturn(Integer dsixreturnCode, String cmdStatus,
			String textResponse, String authCode, Integer refNo,
			String acqRefData, String recordNo, BigDecimal purchaseAmount,
			BigDecimal authorizeAmount, String processData, Set payments) {
	...
	public Integer getPaymentReturnId() {
		return this.paymentReturnId;
	}

	public void setPaymentReturnId(Integer paymentReturnId) {
		this.paymentReturnId = paymentReturnId;
	}
