...
/**
 * PaymentPreAuth generated by hbm2java
 */
public class PaymentPreAuth implements java.io.Serializable {

	private Integer paymentPreAuthId;
	...
	public PaymentPreAuth() {
	}

	public PaymentPreAuth(BigDecimal purchaseAmount, BigDecimal authorizeAmount) {
		this.purchaseAmount = purchaseAmount;
		this.authorizeAmount = authorizeAmount;
	}

	public PaymentPreAuth(Integer dsixreturnCode, String cmdStatus,
	...
	public Integer getPaymentPreAuthId() {
		return this.paymentPreAuthId;
	}

	public void setPaymentPreAuthId(Integer paymentPreAuthId) {
